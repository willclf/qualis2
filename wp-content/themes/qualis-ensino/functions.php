 ...
 * CSS / JS
 */
function webi_scripts()
{
    global $post;
    wp_enqueue_script('googleapis-jquery', get_template_directory_uri() . '/assets/vendor/js/jquery/jquery.min.js', array(), '3.3.1', false);
    wp_localize_script('webitheme-js', 'ajax_admin', array('ajax_url' => admin_url('admin-ajax.php'), 'nonce' => wp_create_nonce('ajax-nonce')));
    // FONTAWESOME
    ...
    switch ($template_name) {
        case "index.php":
            ...
            load_script('script');
            break;
        case "page-cursos.php":
            load_style('home');
            load_style('cursos');
            load_script('script');
            break;
        case "page-contato.php":
            load_style('home');
            load_style('cursos');
            load_style('contato');
            load_script('script');
            break;
        case "single-card_cursos.php":
            load_style('home');
            load_style('cursos');
            load_style('contato');
            load_script('script');
...
add_action('wp_enqueue_scripts', 'webi_scripts');
